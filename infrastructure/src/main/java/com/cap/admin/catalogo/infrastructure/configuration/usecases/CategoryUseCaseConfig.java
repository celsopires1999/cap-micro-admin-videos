...
import com.cap.admin.catalogo.application.category.delete.DefaultDeleteCategoryUseCase;
import com.cap.admin.catalogo.application.category.delete.DeleteCategoryUseCase;
import com.cap.admin.catalogo.application.category.retrieve.get.DefaultGetCategoryByIdUseCase;
import com.cap.admin.catalogo.application.category.retrieve.get.GetCategoryByIdUseCase;
import com.cap.admin.catalogo.application.category.retrieve.list.DefaultListCategoriesUseCase;
import com.cap.admin.catalogo.application.category.retrieve.list.ListCategoriesUseCase;
import com.cap.admin.catalogo.application.category.update.DefaultUpdateCategoryUseCase;
